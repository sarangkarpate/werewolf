...
style = {'bear': ['🐻', discord.ButtonStyle.primary], 'Ammar-bear': ['🧸', discord.ButtonStyle.primary],
         ...
         'masons': ['👥', discord.ButtonStyle.green], 'thing': ['☝', discord.ButtonStyle.green],
         ...
         'mason-sorceress': ['👥', discord.ButtonStyle.red], 'minion': ['💩', discord.ButtonStyle.red],
         'villager': ['🤠', discord.ButtonStyle.green]}
